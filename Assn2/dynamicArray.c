...
{	
    ...
    assert(v != 0);
    //Declare a new array, and this array has the new capacity
    TYPE *tmpArr = (TYPE *)malloc(newCap * sizeof(TYPE));
    //Use for loop to copy the original array to the new one
